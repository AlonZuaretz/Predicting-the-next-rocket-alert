...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Example script with input parameters.")
    parser.add_argument("--param1", required=True, type=str, help="First parameter")
    parser.add_argument("--param2", required=True, type=int, help="Second parameter")
    parser.add_argument("--param3", required=True, type=int, help="Second parameter")
    args = parser.parse_args()

    evaluate(args.param1, args.param2, args.param3)
